...
public class TestsAdmin 
{
    ...
    public void testIngresarPieza()
    {
        ...
        Pieza piezaAgregada = GaleriaPrueba.getInventario().getPiezasExhibidad().get(GaleriaPrueba.getInventario().getPiezasExhibidad().size()-1);
        ...
        piezaAgregada = GaleriaPrueba.getInventario().getPiezasBodega().get(GaleriaPrueba.getInventario().getPiezasBodega().size()-1);
